...
async function main() {
  ...
  try {
    ...
    const tasks = [
      'Implement secure authentication middleware with input validation',
      'Refactor the hook-handler dispatch to reduce code duplication',
      'Add comprehensive test coverage for guidance gates',
      'Fix a bug in the session persistence layer',
    ];
